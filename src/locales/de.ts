...
export const de: TranslationMessages = {
  ...
  "command.syncNow": "Jetzt synchronisieren",
  "command.submitCorrection": "Korrektur senden",
  "command.resetLocalDraft": "Lokalen Entwurf zurücksetzen",
  "command.markDelete": "Löschen markieren",
  "command.confirmDelete": "Löschen bestätigen",
  "command.showRevisionHistory": "Revisionsverlauf anzeigen",
  "command.openLinkedCorrection": "Verknüpfte Korrektur öffnen",
  "command.revealOvUri": "OpenViking-Pfad anzeigen",
